...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppStyles.buildHeader(title: 'Alterar Senha'), // Cabeçalho reutilizável
      body: Center(
        child: Column(
                      ...
                      children: [
                        ...
                        HoverText(
                          ...
                          onTap: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(builder: (context) => AppPerfilUser()), // Redireciona para a tela principal
                            );
                          },
                        ),
                      ],
